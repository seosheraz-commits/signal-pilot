    ...
    <div className="rounded-xl border border-[#1b1b1b] p-3">
      ...
      <div className="flex flex-wrap gap-3 items-end">
        <div>
          ...
          <input
            className="bg-[#0e0f12] border border-[#1b1b1b] rounded-lg px-2 py-1 w-32"
            value={balance}
        ...
        <div>
          ...
          <input
            className="bg-[#0e0f12] border border-[#1b1b1b] rounded-lg px-2 py-1 w-24"
            value={riskPct}
        ...
        <div>
          ...
          <input
            className="bg-[#0e0f12] border border-[#1b1b1b] rounded-lg px-2 py-1 w-20"
            value={lev}
            onChange={(e)=>setLev(Number(e.target.value)||0)}
          />
        </div>
      </div>
